...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = " name of college";
        drawhead(-490, 900, 0, cn);
        char pn[] = "location of college with city code ";
        ...
        char g1[] = "proffessor name";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor, Dept. Of cSE, college name";
...
compilation process:
gedit atomsimulation.cpp
g++ atomsimulation.cpp  -lglut -lGLU -lGL
./a.out
